...
if not isfolder("visualsense") then
    makefolder("visualsense")
end

if not isfolder("visualsense/configs") then
    makefolder("visualsense/configs")
end

if not isfolder("visualsense/configs/da_hood") then
    makefolder("visualsense/configs/da_hood")
end
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'visualsense<font color="rgb(168, 157, 159)">.</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("visualsense.universal")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            local config = {
                                path = "visualsense/configs/da_hood/",
                                file = "",
                                config_name = ""
                            }
                            function config:get_list()
                                ...
                                if #listfiles("visualsense/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("visualsense/configs/da_hood") do
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'visualsense<font color="rgb(168, 157, 159)">.universal</font>',}
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local title = fucking_shitty_indicator:new_indicator("visualsense.universal")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
